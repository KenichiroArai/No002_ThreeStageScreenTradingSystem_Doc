...
INSERT INTO code_value (id,start_date,end_date,locale_id,creator,created_date,updater,update_date,note,name,code_kind_id) VALUES (6,'-infinity','infinity','ja','init','2021/05/31 00:00:00.000','init','2021/05/31 00:00:00.000',null,'その他',2);
